...
class FactorsControllerTest < ActionController::TestCase
  ...
  test "should create factor" do
    assert_difference('Factor.count') do
      post :create, factor: { show_in_survey: @factor.show_in_survey, title: @factor.title, type: @factor.type }
    end
  ...
  test "should update factor" do
    put :update, id: @factor, factor: { show_in_survey: @factor.show_in_survey, title: @factor.title, type: @factor.type }
    assert_redirected_to factor_path(assigns(:factor))
  end
